...
It renames all the occurrences of tim (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the tim folder
        os.rename(
            os.path.join(root_dir_path, "exts", "tim", "tim"),
            os.path.join(root_dir_path, "exts", "tim", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "tim"), os.path.join(root_dir_path, "exts", new_name))
