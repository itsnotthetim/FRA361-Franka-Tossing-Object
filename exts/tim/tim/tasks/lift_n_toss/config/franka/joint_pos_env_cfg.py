...
import sys
import os
# Add exts/tim to the system path
current_dir = os.path.dirname(__file__)
tim_path = os.path.abspath(os.path.join(current_dir, '..', '..', '..', '..', '..', 'exts', 'tim'))
if tim_path not in sys.path:
    sys.path.append(tim_path)
        ...
        self.scene.basket = RigidObjectCfg(
                ...
                spawn=UsdFileCfg(
                    ...
                    rigid_props=RigidBodyPropertiesCfg(
                        ...
                        max_linear_velocity=1000.0,
                        max_depenetration_velocity=5.0,
                        disable_gravity=False,   # Prevent gravity from acting on the basket
                        kinematic_enabled=False       # Make it a kinematic (fixed) object
                    ),
                ),
        )
